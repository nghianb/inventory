...
- Dòng bị bỏ vì lỗi định dạng hoặc trùng khi nhập, và **Đơn vị hàng** Lỗi chưa giao Slot nào, đều là chất lượng của **Nhà cung cấp** nhưng không phải hàng lỗi đến tay khách. Đã chốt: báo cáo Tỉ lệ lỗi để chúng ở hai cột riêng (Dòng lỗi/trùng khi nhập, Lỗi trong kho), ngoài tử số lẫn mẫu số của Tỉ lệ lỗi.
