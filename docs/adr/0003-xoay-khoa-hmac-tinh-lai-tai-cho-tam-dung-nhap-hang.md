...
- `dedupe_key_version` mặc định 1 cho hàng cũ: giá trị sai lệch chỉ làm nhập hàng *dừng* (fail-safe), không bao giờ làm chống trùng sai.
