...
class ViewBatch extends ViewRecord
{
    ...
    {
        return [
            // Khai một lần trong BatchActions vì dải quyết định trong thân trang bày lại đúng hai
            // nút này (bố cục "Bàn làm việc"): xem BatchResource::infolist().
            BatchActions::confirm(),
            BatchActions::revise(),
