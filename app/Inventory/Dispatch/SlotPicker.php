...
/**
 * Chọn Slot theo Thứ tự xuất và giao, dùng chung cho tạo Phiếu xuất, Giao thêm và Giao thay. Người
 * gọi chạy trong transaction và ghi Sổ biến động kho.
 */
final class SlotPicker
{
     ...
     */
    public static function deliver(int $dispatchLineId, Product $product, Collection $slots, User $actor, CarbonInterface $now, ?int $correctsDeliveryId = null): array
    {
        DB::table('slots')
